...
-- window bg
vim.cmd("highlight Normal guibg=#212526 ctermbg=NONE")

-- floating window bg color
vim.cmd("highlight NormalFloat guibg=#212526 ctermbg=NONE")
vim.cmd("highlight DiagnosticFloating guibg=#212526 ctermbg=NONE")
